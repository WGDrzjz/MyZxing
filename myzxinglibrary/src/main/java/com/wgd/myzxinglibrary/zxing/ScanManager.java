package com.wgd.myzxinglibrary.zxing;
...
import com.wgd.myzxinglibrary.R;
import com.wgd.myzxinglibrary.zxing.camera.CameraManager;
import com.wgd.myzxinglibrary.zxing.decode.DecodeThread;
import com.wgd.myzxinglibrary.zxing.decode.PhotoScanHandler;
import com.wgd.myzxinglibrary.zxing.decode.RGBLuminanceSource;
import com.wgd.myzxinglibrary.zxing.utils.BeepManager;
import com.wgd.myzxinglibrary.zxing.utils.BitmapUtil;
import com.wgd.myzxinglibrary.zxing.utils.CaptureActivityHandler;
import com.wgd.myzxinglibrary.zxing.utils.InactivityTimer;
...
public class ScanManager implements SurfaceHolder.Callback {
    ...
    public ScanManager(ScanListener listener) {
        DecodeThread decodeThread = new DecodeThread(this, DecodeThread.QRCODE_MODE);
        decodeThread.start();
        this.listener = listener;
    }
    ...
    public void handleDecode(Result rawResult, Bundle bundle) {
        ...
        if (null!=mCropRect)bundle.putInt("width", mCropRect.width());
        if (null!=mCropRect)bundle.putInt("height", mCropRect.height());
        bundle.putString("result", rawResult.getText());
        if (null!=listener)listener.scanResult(rawResult, bundle);
